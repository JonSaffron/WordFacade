' Fields is a 1 based collection of object Field
Public Class Fields
    Implements IEnumerable(Of Field)
    Implements IEnumerator(Of Field)
    Implements IDisposable

    Private ReadOnly _fields As Object

    Friend Sub New(ByVal fields As Object)
        Me._fields = fields
        Call Me.Reset()
    End Sub
    ...
    Public ReadOnly Property Count() As Integer
        Get
            Return Me._fields.Count
        End Get
    End Property

    Default Public ReadOnly Property Item(ByVal index As Integer) As Field
        Get
            Return New Field(Me._fields.Item(index))
        End Get
    End Property

    Public Function Update() As Integer
        Return Me._fields.Update
    End Function

#Region " IEnumerable implementation"
    Public Function GetEnumeratorOfField() As System.Collections.Generic.IEnumerator(Of Field) Implements System.Collections.Generic.IEnumerable(Of Field).GetEnumerator
        Return Me
    End Function
...
#Region " IEnumerator implementation"
    ...
    Public ReadOnly Property CurrentOfField() As Field Implements System.Collections.Generic.IEnumerator(Of Field).Current
        Get
